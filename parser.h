...
public:
    ...
    c_Predicate(){};
    c_Predicate(string name) : name(name) {};
    //make getParameters
...
class c_Rules {
    public:
        ...
        c_Rules(){}
        c_Rules(const c_Predicate& head) : headPredicate(head) {}

        void addBodyPredicate(c_Predicate p) {
        ...
        string head_to_string() const {
            stringstream out;
            out << headPredicate.name << endl;
        }

        vector<c_Predicate> bp_get_parameters() {
            return bodyPredicates;
        }
        c_Predicate get_head(){
 ...
 public:
    ...
    void parse(){
        ...
        try {
            ...
            // c_Rules obj;
            // string hp_name = obj.head_to_string();
            // cout << hp_name << endl;
        }
